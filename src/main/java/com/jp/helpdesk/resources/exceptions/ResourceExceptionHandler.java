package com.jp.helpdesk.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFoundEsception(ObjectNotFoundException ex, HttpServletRequest request) {
	...
	public ResponseEntity<StandardError> validationErrors(MethodArgumentNotValidException ex, HttpServletRequest request) {
		...
		ex.getBindingResult().getFieldErrors().forEach(err -> errors.addError(err.getField(), err.getDefaultMessage()));
